...
- 安装 Astro `npm create astro@latest`
- 启动服务 `npm run dev`

2. **制作页面**：然后我学习了如何通过创建新的 `.astro` 文件并将它们保存在 `src/pages/` 文件夹里来制作页面。

   - 使用 layouts 简化代码
   - 编写 MySiteLayout.astro
   ...
   - 编写 BlogPostLayout.astro

     ```html
     --- // 1. `frontmatter` prop 提供了访问 frontmatter 和其他数据的能力 const
...
1. 我将完成 Astro 教程，同时学习[web 开发](https://developer.mozilla.org/zh-CN/docs/Learn_web_development)
2. 完善我的网站
